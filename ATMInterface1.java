...
class ATM {
    ...
    public ATM() {
        users = new HashMap<>();
        users.put("Supraja123", new User("Supraja123", "9392", 1000.0));
        users.put("Raju456", new User("Raju456", "5678", 1500.0));
        users.put("Akhil789", new User("Akhil789", "4854", 1700.0));
        users.put("Manasa011", new User("Manasa011", "5088", 1300.0));
        users.put("Poojitha678", new User("Poojitha678", "0999", 1600.0));
        users.put("Anusha087", new User("Anusha087", "8730", 1900.0));
